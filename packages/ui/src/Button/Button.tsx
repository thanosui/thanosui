...
export const Button = (props: any) => {
	...
	const handleClick = (e: any) => {
		...
		setRipples((prevRipples: any) => [...prevRipples, { x, y, color: 'rgba(255, 255, 255, 0.5)' }]);
		onClick(e);
	};

	const baseStyles = cx('transition duration-100', button({ color, disabled, size, radius, variant }), className);
